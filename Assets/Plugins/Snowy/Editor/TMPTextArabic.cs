...
namespace TMPro.EditorUtilities
{
    ...
    public class TMP_EditorPanelUI : TMP_BaseEditorPanel
    {
        ...
        protected override void DrawExtraSettings()
        {
            ...
            if (GUILayout.Button("Fix Arabic"))
            {
                m_TextComponent.text = ArabicSupport.ArabicFixer.Fix(m_TextComponent.text);
                
                // refresh the editor
                EditorUtility.SetDirty(m_TextComponent);
                EditorUtility.SetDirty(m_TextComponent.gameObject);
                EditorSceneManager.MarkSceneDirty(m_TextComponent.gameObject.scene);
            }
